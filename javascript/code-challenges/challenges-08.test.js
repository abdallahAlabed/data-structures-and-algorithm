...
Write a function named containsW that takes in a string. This function should use a regular expression pattern to return true
...
Write a function named isNum that takes in a string or number of any length. This function should use a regular expression pattern to return true
 if the input contains a number, and false if the input does not contain a number.
...
Write a Function named ^ citiesAtoJ that takes in an array of city names and uses a regular expression pattern to return 
